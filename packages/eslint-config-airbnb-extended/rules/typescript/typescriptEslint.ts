...
import styleRule from '@/rules/style';
...
const typescriptEslintRules = {
  ...
  rules: {
    ...
    'brace-style': 'off',
    '@typescript-eslint/brace-style': styleRule.rules['brace-style'],
    ...
    '@typescript-eslint/comma-dangle': [
      styleRule.rules['comma-dangle'][0],
      {
        ...styleRule.rules['comma-dangle'][1],
        enums: styleRule.rules['comma-dangle'][1].arrays,
        generics: styleRule.rules['comma-dangle'][1].arrays,
        tuples: styleRule.rules['comma-dangle'][1].arrays,
      },
    ],
    ...
    'comma-spacing': 'off',
    '@typescript-eslint/comma-spacing': styleRule.rules['comma-spacing'],
    ...
    '@typescript-eslint/func-call-spacing': styleRule.rules['func-call-spacing'],

    // Replace Airbnb 'indent' rule with '@typescript-eslint' version
    // https://github.com/typescript-eslint/typescript-eslint/blob/master/packages/eslint-plugin/docs/rules/indent.md
    indent: 'off',
    '@typescript-eslint/indent': styleRule.rules.indent,

    // Replace Airbnb 'keyword-spacing' rule with '@typescript-eslint' version
    // https://github.com/typescript-eslint/typescript-eslint/blob/master/packages/eslint-plugin/docs/rules/keyword-spacing.md
    'keyword-spacing': 'off',
    '@typescript-eslint/keyword-spacing': styleRule.rules['keyword-spacing'],

    // Replace Airbnb 'lines-between-class-members' rule with '@typescript-eslint' version
    // https://github.com/typescript-eslint/typescript-eslint/blob/master/packages/eslint-plugin/docs/rules/lines-between-class-members.md
    'lines-between-class-members': 'off',
    '@typescript-eslint/lines-between-class-members':
      styleRule.rules['lines-between-class-members'],

    // Replace Airbnb 'no-array-constructor' rule with '@typescript-eslint' version
    // https://github.com/typescript-eslint/typescript-eslint/blob/master/packages/eslint-plugin/docs/rules/no-array-constructor.md
    'no-array-constructor': 'off',
    '@typescript-eslint/no-array-constructor': styleRule.rules['no-array-constructor'],
    ...
    '@typescript-eslint/space-before-blocks': styleRule.rules['space-before-blocks'],
    ...
    quotes: 'off',
    '@typescript-eslint/quotes': styleRule.rules.quotes,

    // Replace Airbnb 'semi' rule with '@typescript-eslint' version
    // https://github.com/typescript-eslint/typescript-eslint/blob/master/packages/eslint-plugin/docs/rules/semi.md
    semi: 'off',
    '@typescript-eslint/semi': styleRule.rules.semi,

    // Replace Airbnb 'space-before-function-paren' rule with '@typescript-eslint' version
    // https://github.com/typescript-eslint/typescript-eslint/blob/master/packages/eslint-plugin/docs/rules/space-before-function-paren.md
    'space-before-function-paren': 'off',
    '@typescript-eslint/space-before-function-paren':
      styleRule.rules['space-before-function-paren'],
    ...
    'space-infix-ops': 'off',
    '@typescript-eslint/space-infix-ops': styleRule.rules['space-infix-ops'],

    // Replace Airbnb 'object-curly-spacing' rule with '@typescript-eslint' version
    // https://github.com/typescript-eslint/typescript-eslint/blob/master/packages/eslint-plugin/docs/rules/object-curly-spacing.md
    'object-curly-spacing': 'off',
    '@typescript-eslint/object-curly-spacing': styleRule.rules['object-curly-spacing'],
  },
